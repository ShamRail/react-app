    ...
    return (
        <div className="pagination__wrapper">
            <div className="pagination">
                <button className="pagination__btn pagination__btn_older" disabled={pageList[0] === 1} onClick={decreasePage}>
                ...
                <button className="pagination__btn pagination__btn_next" disabled={pageList[pageList.length - 1] === 15} onClick={increasePage}>
                    <span>NEXT POST</span>
