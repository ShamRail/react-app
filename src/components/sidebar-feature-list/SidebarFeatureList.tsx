...
const css = {width: 270, margin: '15px 0 15px 0'};
...
export const SidebarFeatureList = () => {
    return (
        <div className="sidebar__featured-posts">
            ...
            <Post topic={'Jeans'} date={'June 6, 2019'} author={'Rickie Baroch'} image={aside2} css={css}
                  title={'One of Saturn\'s largest rings may be newer than anyone'}/>
            <Post topic={'City'} date={'June 6, 2019'} author={'Rickie Baroch'} image={aside3} css={css}
                  title={'One of Saturn\'s largest rings may be newer than anyone'}/>
            <Post topic={'Photography'} date={'June 6, 2019'} author={'Rickie Baroch'} image={aside4} css={css}
                  title={'One of Saturn\'s largest rings may be newer than anyone'}/>
        </div>
    );
}